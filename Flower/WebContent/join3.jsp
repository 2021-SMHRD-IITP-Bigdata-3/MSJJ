...
<div class="rows navi_category" style="width:1000px; margin:0 auto; ">
    	<div style="width:650px; float:left; text-align:left; "><span style="font-family:noto; font-size:25px; line-height:25px; color:#333 ;padding-right:10px;">회원가입</span> <span style="font-family:noto_light; font-size:16px; color:#666">꽃으로 사랑하는 사람에게 진심을 전해보세요.</span>
        </div>
...
<tbody><tr style="height:50px;">
	...
	<input type="text" name="m_id" value="" style="width:200px;" maxlength="16&quot;" required="" fld_esssential="" option="regId" label="아이디">
...
<tr style="height:50px;">
	...
	<td class="memberCols2">
	<input type="password" name="password" required="" fld_esssential="" option="regPass" label="비밀번호" style="width:200px;" onfocus="checkPassword(this)" onkeyup="checkPassword(this)" onblur="emptyPwState()" maxlength="16">
...
<tr style="height:50px;">
	...
	<td class="memberCols2">
	<input type="password" name="password2" required="" fld_esssential="" option="regPass" style="width:200px;" label="비밀번호" maxlength="16">
	</td>
</tr>
<tr><td colspan="2" height="1" bgcolor="#DEDEDE" style="padding:0px;"></td></tr>
<tr style="height:50px;">
...
<tr style="height:70px;">
	...
	<td class="memberCols2">
	<input type="text" name="mobile[]" id="mobile0" style="width:200px;" value="" size="4" maxlength="4" required="" fld_esssential="" option="regNum" label="핸드폰">
