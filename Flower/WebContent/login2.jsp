...
<div class="rows navi_category" style="width:1000px; margin:0 auto; ">
    	<div style="width:650px; float:left; text-align:left; "><span style="font-family:noto; font-size:25px; line-height:25px; color:#333 ;padding-right:10px;">로그인</span> <span style="font-family:noto_light; font-size:16px; color:#666">꽃으로 사랑하는 사람에게 진심을 전해보세요.</span>
        </div>
		...
		<div style="margin-left: 45px ;width:400px; padding-right: 40px;margin-right: 45px;">
			...
			<div>
				...
				<tr>
					...
					<td><input type="password" name="password" size="20" tabindex="2" style="width:215px;padding:5px;"></td>
				</tr>
